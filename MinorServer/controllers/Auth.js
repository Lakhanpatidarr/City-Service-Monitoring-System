...
exports.signUp = async (req, res) => {
    try {
        ...
        const user = await User.create({ fullname, email, password: hashedPassword, accountType: "Public", additionalDetails: profileDetails._id, dob, select, image: `https://api.dicebear.com/5.x/initials/svg?seed=${fullname}`, department: undefined });
